...
echo ======================================
echo   Windows 系统代理彻底重置工具 v2
echo ======================================
echo.

echo [1/7] 备份注册表代理配置与 hosts 文件
...
echo [4/7] 清除 Connections 二进制代理残留
...
echo [5/7] 重置 WinHTTP 代理、刷新 DNS
netsh winhttp reset proxy >nul
ipconfig /flushdns >nul
echo.

echo [6/7] 检查仍在运行的代理客户端进程
...
echo 5. 仍有网页跳转:查浏览器扩展、查 hosts(已自动备份)、全盘杀毒
echo 6. 恢复代理设置:双击 %BACKUP_REG% 即可还原
echo.
pause
exit
